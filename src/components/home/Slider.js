...
const Slider = () => {
    ...
    <div className="absolute  top-1/4 info ">
      ...
      <p className='text-white py-7'>We believe that marriages are a promise of forever, synonymous to “…and they lived happily ever after.” We are here to encapsulate your "happily ever after" onto the screen just as magically as you had imagined.</p>
